          ...
          <div className="w-24 h-24 sm:w-28 sm:h-28 relative flex items-center justify-center">
            ...
            >
              ...
              <path
                ...
                fill="url(#authJarGlassGradient2)"
              ...
              <path
                ...
                fill="url(#authJarLiquidGradient2)"
                opacity="0.85"
              />
              ...
              {/* Gradients */}
              <defs>
                <linearGradient id="authJarGlassGradient2" x1="0" y1="0" x2="1" y2="1">
                  <stop offset="0%" stopColor="rgba(56, 189, 248, 0.15)" />
                  <stop offset="50%" stopColor="rgba(255, 0, 127, 0.08)" />
                  <stop offset="100%" stopColor="rgba(15, 23, 42, 0.6)" />
                </linearGradient>
                <linearGradient id="authJarLiquidGradient2" x1="0" y1="0" x2="1" y2="1">
